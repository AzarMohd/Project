...
import { Navbar, Container, Form, FormControl, Nav, NavDropdown, Button } from 'react-bootstrap';
            ...
            <Navbar bg="light" expand="lg">
                <Container fluid>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Form>
                            <FormControl
                                style={{border:"none",boxShadow:"none",outline:"none",borderBottom:"0.1px solid  #0099ff",borderRadius:"0px",backgroundColor:"transparent"}}
                                type="search"
                                placeholder="Search"
                                aria-label="Search"
                            />
